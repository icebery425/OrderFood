...
public abstract class ObjectUtils {
    ...
    public static Object clone(Serializable object) {
        ...
        try {
            ...
            throw new RuntimeException(object.getClass().getName() + "鍏嬮殕澶辫触[鎶婂璞¤浆鎹㈡垚鍐呭瓨鏁扮粍澶辫触]", e);
        } finally {
            try {
                out.close();
            } catch (IOException e) {
        ...
        try {
            ...
            throw new RuntimeException(object.getClass().getName() + "鍏嬮殕澶辫触[璇诲彇鍐呭瓨鏁扮粍涓殑瀵硅薄澶辫触]", e);
        } finally {
            try {
                objectIn.close();
            } catch (IOException e) {
