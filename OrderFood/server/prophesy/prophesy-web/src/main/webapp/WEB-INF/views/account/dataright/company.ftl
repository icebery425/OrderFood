...
<div class="wrapper wrapper-content" style="padding-bottom:20px">
	...
	<div class="box-control" style="position: relative;">
	    <label class="control-label min-w90" style="margin: 20px 0 10px auto;position:relative;top:2px;">已选地区公司</label>
	    ...
	    <label class="control-label min-w90" style="margin: 20px 0 10px auto;">全部地区公司</label>
	    <div>
