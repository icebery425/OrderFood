package com.worldunion.prophesy.generator.plugin;
...
public class OraclePaginationPlugin extends PluginAdapter
{
	...
	{
		topLevelClass.addImportedType(new FullyQualifiedJavaType("com.worldunion.bi.generator.page.Page"));
		CommentGenerator commentGenerator = context.getCommentGenerator();
		Field field = new Field();
		field.setVisibility(JavaVisibility.PROTECTED);
		field.setType(new FullyQualifiedJavaType("com.worldunion.bi.generator.page.Page"));
		field.setName(name);
		...
		method.addParameter(new Parameter(new FullyQualifiedJavaType("com.worldunion.bi.generator.page.Page"), name));
		method.addBodyLine("this." + name + "=" + name + ";");
		commentGenerator.addGeneralMethodComment(method, introspectedTable);
		topLevelClass.addMethod(method);
		method = new Method();
		method.setVisibility(JavaVisibility.PUBLIC);
		method.setReturnType(new FullyQualifiedJavaType("com.worldunion.bi.generator.page.Page"));
